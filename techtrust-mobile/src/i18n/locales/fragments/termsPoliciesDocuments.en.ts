/**
 * Customer Terms & Policies — English legal copy (primary for counsel review).
 * PT/ES fragments mirror structure for UX; confirm with counsel before relying on translations in disputes.
 */
export default {
  terms: {
    title: 'Terms of Use',
