...
export default function LandingScreen({ navigation }: LandingScreenProps) {
  ...
  const getServiceLabel = (serviceIdOrName: string): string => {
    ...
    const mapById: Record<string, string> = {
      oilChange:
        t.createRequest?.serviceOilChange ||
        t.serviceTypes?.oilChange ||
        "Oil Change",
      brakes:
        t.createRequest?.serviceBrakes || t.serviceTypes?.brakes || "Brakes",
      tires: t.createRequest?.serviceTires || "Tires",
      engine:
        t.createRequest?.serviceEngine || t.serviceTypes?.engine || "Engine",
      transmission:
        t.createRequest?.serviceTransmission ||
        t.serviceTypes?.transmission ||
        "Transmission",
      ac: t.createRequest?.serviceAC || "A/C",
      electrical: t.createRequest?.serviceElectrical || "Electrical",
      suspension:
        t.createRequest?.serviceSuspension ||
        t.serviceTypes?.suspension ||
        "Suspension",
      diagnostics: t.serviceTypes?.diagnostics || "Diagnostics",
      inspection:
        t.createRequest?.serviceInspection ||
        t.serviceTypes?.vehicleInspection ||
        "Inspection",
    };
  ...
  const serviceOptions = SERVICE_TYPE_IDS.map((id) => ({
    id,
  ...
  const menuItems = isAuthenticated
    ? [
        ...
        {
          icon: "car",
          label: t.nav?.vehicles || "My Vehicles",
    ...
    : [
        ...
        },
        {
          ...
          label: t.common?.info || "About Us",
          action: () => {},
        },
      ];

  const providersToShow = isAuthenticated
    ? searchResults.slice(0, 10)
    : searchResults;
  const filterSummary =
    [
      selectedService &&
        `${t.common?.serviceType || "Service Type"}: ${getServiceLabel(selectedService)}`,
      ...
      >
        ...
        <View style={styles.offerContent}>
          ...
          <Text style={styles.validUntil}>
            {t.landing?.offers?.validUntil || "Valid until"} {validUntilStr}
          </Text>
        </View>
        <View style={styles.offerTapHint}>
          <Ionicons name="finger-print" size={16} color="#6b7280" />
          <Text style={styles.offerTapHintText}>
            {t.landing?.offers?.tapForDetails || "Tap for details"}
          </Text>
        </View>
      </TouchableOpacity>
    );
  ...
  const renderProvider = ({
    ...
    <View
      style={[
        styles.providerCard,
        variant === "horizontal" && styles.providerCardHorizontal,
      ]}
    >
      ...
      <View style={styles.providerFooter}>
        <View style={styles.safeTransactionTip}>
          ...
          <Text style={styles.safeTransactionText}>
            {t.common?.safeTransactionTip ||
              "Always use the platform for secure transactions"}
          </Text>
        </View>
        {isAuthenticated ? (
          <TouchableOpacity
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
          ...
          >
              ...
              <View style={styles.searchFilters}>
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.filterText,
                      !selectedState && styles.filterPlaceholder,
                    ]}
                  >
                ...
                <TouchableOpacity
                  style={[
                    ...
                    !selectedState && styles.filterDisabled,
                  ]}
                  onPress={() =>
                    selectedState && setShowCityDropdown(!showCityDropdown)
                  }
                >
                  ...
                  <Text
                    style={[
                      styles.filterText,
                      !selectedCity && styles.filterPlaceholder,
                    ]}
                  >
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.filterText,
                      !selectedService && styles.filterPlaceholder,
                    ]}
                  >
                    {selectedService
                ...
                <View style={styles.searchResults}>
                  <View style={styles.resultsHeader}>
                    <Text style={styles.resultsTitle}>
                      ...
                      {searchResults.length !== 1
                        ? t.common?.providersFound || "Providers Found"
                        : t.common?.providerFound || "Provider Found"}
                    </Text>
                  ...
                  {!isAuthenticated && (
                    <View style={styles.registerCTA}>
                      <Text style={styles.registerCTATitle}>
                        {t.landing?.cta?.wantFullAccess || "Want full access?"}
                      </Text>
                      <Text style={styles.registerCTAText}>
                        {t.landing?.cta?.registerDesc ||
                      ...
                      <View style={{ gap: 10 }}>
                        ...
                        >
                          <Text style={styles.registerCTAButtonText}>
            ...
            <View style={styles.section}>
              <View style={styles.sectionHeaderLarge}>
                ...
                <View>
                  <Text style={styles.sectionTitle}>
                    {t.landing?.benefits?.title || "Why TechTrust?"}
                  </Text>
                  <Text style={styles.sectionSubtitle}>
              ...
              <View style={styles.footerCTA}>
                ...
                <View style={styles.footerCTAButtons}>
                  <TouchableOpacity
                    ...
                    onPress={handleSignup}
                  >
                    <Text style={styles.footerCTAButtonPrimaryText}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={handleLogin}
                  >
                    <Text style={styles.footerCTAButtonSecondaryText}>
                      {t.auth?.login || "Login"}
                    </Text>
                  </TouchableOpacity>
                </View>
        ...
        <SafeAreaView style={styles.fullResultsContainer}>
          <View style={styles.fullResultsHeader}>
            ...
            <Text style={styles.fullResultsTitle}>
              {t.landing?.search?.results || "Providers found"}
            </Text>
            <View style={{ width: 24 }} />
          </View>
      ...
      <Modal visible={showServiceDropdown} transparent animationType="fade">
        ...
        >
          <View style={styles.dropdownContent}>
            <Text style={styles.dropdownTitle}>
              {t.landing?.search?.selectService || "Select Service Type"}
            </Text>
            <ScrollView style={styles.dropdownScroll}>
              {serviceOptions.map(({ id, label }) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.dropdownItem,
                    selectedService === id && styles.dropdownItemSelected,
                  ]}
                  onPress={() => {
                ...
                >
                  <Text
                    style={[
                      styles.dropdownItemText,
                      selectedService === id && styles.dropdownItemTextSelected,
                    ]}
                  >
                    {label}
                  </Text>
          ...
          <View style={styles.menuContent}>
            ...
            {!isAuthenticated && (
              <View style={styles.menuFooter}>
                ...
                >
                  <Text style={styles.menuSignupButtonText}>
          ...
          <View style={styles.offerProvidersModalContent}>
            <View style={styles.offerProvidersModalHeader}>
              ...
              <Text style={styles.offerProvidersModalTitle}>
                {t.landing?.findParticipatingProviders ||
              ...
              {hasSearchedOfferProviders ? (
                offerProviders.length > 0 ? (
                  <>
                    <Text style={styles.offerProvidersResultsTitle}>
                      {(
                        t.landing?.participatingProviders ||
                        "{count} Participating Provider(s)"
                      ).replace("{count}", offerProviders.length.toString())}
                    </Text>
                  ...
                  <View style={styles.offerProvidersNoResults}>
                    ...
                    <Text style={styles.offerProvidersNoResultsText}>
                      {t.common?.noResults || "No providers found"}
                    </Text>
                    <Text style={styles.offerProvidersNoResultsSubtext}>
                      {t.landing?.tryDifferentLocation ||
                ...
                <View style={styles.offerProvidersEmptyState}>
                  ...
                  <Text style={styles.offerProvidersEmptyText}>
                    {t.landing?.selectLocationPrompt ||
