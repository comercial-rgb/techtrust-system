...
export default function ProviderQuoteDetailsScreen({ route, navigation }: any) {
  ...
  const loadQuoteDetails = async () => {
    ...
    try {
      ...
      const mockQuote: QuoteDetails = {
        ...
        laborCost: 250.0,
        lineItems: [
          { id: '1', type: 'part', description: 'Filtro de óleo - Mann W719/45', quantity: 1, unitPrice: 35.0 },
          { id: '2', type: 'part', description: 'Filtro de ar - K&N 33-2393', quantity: 1, unitPrice: 65.0 },
          { id: '3', type: 'part', description: 'Óleo Motor 5W-30 Sintético', quantity: 5, unitPrice: 20.0 },
          { id: '4', type: 'labor', description: 'Mão de obra - Troca de óleo completa', quantity: 1, unitPrice: 150.0 },
          { id: '5', type: 'labor', description: 'Inspeção multi-pontos', quantity: 1, unitPrice: 100.0 },
        ],
        estimatedDuration: '3h',
        notes: 'Recomendamos também verificar o fluido de freio na próxima visita.',
        warranty: {
          partsWarrantyMonths: 6,
          serviceWarrantyDays: 90,
          terms: 'Garantia válida mediante apresentação do comprovante de serviço.',
        },
        ...
        serviceRequest: {
          ...
          description: 'Troca de óleo motor e filtros (ar e óleo). Veículo com 45.000km.',
          urgency: 'normal',
        },
        vehicle: {
          make: 'Honda',
  ...
  const handleViewWorkOrder = () => {
    navigation.navigate('ProviderWorkOrderDetails', { workOrderId: quote?.id });
  };
