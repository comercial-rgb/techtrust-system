...
export default function ProviderEditProfileScreen({ navigation }: any) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(t.common?.error || 'Error', t.common?.saveFailed || 'Could not save. Please try again.');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t.provider?.editProfile || 'Edit Profile'}</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.logoSection}>
          ...
          <TouchableOpacity style={styles.changeLogoBtn}>
            ...
            <Text style={styles.changeLogoText}>{t.provider?.changeLogo || 'Change Logo'}</Text>
          </TouchableOpacity>
        </View>

        {/* Form */}
        <View style={styles.formSection}>
          <Text style={styles.sectionTitle}>{t.provider?.businessInfo || 'Business Information'}</Text>

          <View style={styles.inputGroup}>
            <Text style={styles.label}>{t.provider?.businessName || 'Business Name'} *</Text>
            <TextInput
              style={styles.input}
              value={businessName}
              onChangeText={setBusinessName}
              placeholder={t.provider?.businessNamePlaceholder || 'Your business name'}
            />
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder={t.provider?.descriptionPlaceholder || 'Describe your business...'}
              multiline
              numberOfLines={4}
        ...
        <View style={styles.formSection}>
          <Text style={styles.sectionTitle}>{t.common?.contact || 'Contact'}</Text>
        ...
        <View style={styles.formSection}>
          <Text style={styles.sectionTitle}>{t.common?.address || 'Address'}</Text>

          <View style={styles.inputGroup}>
            <Text style={styles.label}>{t.provider?.fullAddress || 'Full Address'}</Text>
            <View style={styles.inputWithIcon}>
              ...
              <TextInput
                ...
                placeholder={t.provider?.addressPlaceholder || 'Street, number, city, state'}
              />
            </View>
          </View>
          ...
          <TouchableOpacity style={styles.mapButton}>
            ...
            <Text style={styles.mapButtonText}>{t.provider?.adjustOnMap || 'Adjust on Map'}</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.verificationCard}>
          ...
          <View style={styles.verificationInfo}>
            <Text style={styles.verificationTitle}>{t.provider?.verifiedAccount || 'Verified Account'}</Text>
