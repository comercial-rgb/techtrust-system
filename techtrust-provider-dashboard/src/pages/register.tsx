                  ...
                  <div className="text-white">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-2">
                      ...
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm text-white font-medium px-5 py-3 rounded-xl hover:bg-white/20 transition-all border border-white/20 disabled:opacity-60 text-sm"
                      >
                        {socialLoading ? (
                      ...
                      <button
                        ...
                        disabled={socialLoading}
                        className="flex-1 inline-flex items-center justify-center gap-2 bg-black text-white font-medium px-5 py-3 rounded-xl hover:bg-gray-900 transition-all border border-white/10 disabled:opacity-60 text-sm"
                      >
                        {socialLoading ? (
                          <Loader2 className="w-5 h-5 animate-spin" />
                        ) : (
                    ...
                    <a
                      href="#how-it-works"
                      className="inline-flex items-center gap-2 text-primary-200 hover:text-white text-sm mt-2 transition-colors"
                    >
                ...
                {step === 'info' && (
                  <form onSubmit={handleStep1} className="space-y-4">
                    <div>
                      <button
                        type="button"
                        onClick={() => { setError(''); setGooglePrefilled(false); setStep('landing') }}
                    ...
                    {googlePrefilled && (
                      <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-xl text-sm text-green-800">
                        ...
                        <span>Name and email pre-filled from your Google account. Set a password to complete registration.</span>
                      </div>
                    )}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`input !pl-11 ${googlePrefilled ? 'bg-gray-50 text-gray-600' : ''}`}
