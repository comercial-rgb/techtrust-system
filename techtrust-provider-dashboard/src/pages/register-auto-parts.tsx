                        ...
                        <div className="absolute left-0 top-full mt-1 z-50 bg-white border border-gray-200 rounded-xl shadow-lg w-56 max-h-64 overflow-y-auto">
                          {DIAL_COUNTRIES.map(c => (
                            <button key={c.code} type="button"
                              ...
                              className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-gray-50 ${selectedDialCountry.code === c.code ? 'bg-orange-50 text-orange-700 font-medium' : 'text-gray-700'}`}>
