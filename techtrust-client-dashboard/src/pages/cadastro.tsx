          ...
          {step === 'plan' && (
            <div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-lg bg-white hover:bg-gray-50 transition-all disabled:opacity-50 font-medium text-gray-700 text-sm shadow-sm"
              >
                {socialLoading ? (
              ...
              <button
                ...
                disabled={socialLoading}
                className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-lg bg-black hover:bg-gray-900 transition-all disabled:opacity-50 font-medium text-white text-sm shadow-sm"
              >
                {socialLoading ? (
                  <Loader2 className="w-5 h-5 animate-spin text-gray-400" />
                ) : (
