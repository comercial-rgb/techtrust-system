...
router.get(
  ...
  asyncHandler(async (_req: Request, res: Response) => {
    ...
    const [banners, offers, articles, notices, featuredProviders] =
      await Promise.all([
        // Banners
        prisma.banner.findMany({
          where: {
