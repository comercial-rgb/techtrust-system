...
router.patch('/:id/update-work', asyncHandler(repairInvoiceController.updateWorkPerformed));

// Complete invoice (provider)
router.patch('/:id/complete', asyncHandler(repairInvoiceController.completeInvoice));

// Customer accepts invoice
router.patch('/:id/accept', asyncHandler(repairInvoiceController.acceptInvoice));

// Customer disputes invoice
router.patch('/:id/dispute', asyncHandler(repairInvoiceController.disputeInvoice));
