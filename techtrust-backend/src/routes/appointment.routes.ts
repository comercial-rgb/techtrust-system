...
router.get('/provider/:providerId/slots', asyncHandler(appointmentController.getProviderSlots));

// Get appointment detail
router.get('/:id', asyncHandler(appointmentController.getAppointment));

// Provider confirms appointment
router.patch('/:id/confirm', asyncHandler(appointmentController.confirmAppointment));

// Provider checks in
router.patch('/:id/check-in', asyncHandler(appointmentController.checkInAppointment));

// Complete appointment
router.patch('/:id/complete', asyncHandler(appointmentController.completeAppointment));
