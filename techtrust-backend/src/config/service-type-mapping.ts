...
export const RAW_TO_SERVICE_OFFERED: Record<string, string[]> = {
  ...
  air_filter: ["MAINTENANCE_LIGHT", "OIL_CHANGE", "GENERAL_REPAIR", "AIR_FILTER"],
  belts_hoses: ["MAINTENANCE_LIGHT", "ENGINE", "GENERAL_REPAIR", "BELTS_HOSES"],
  fluids: ["MAINTENANCE_LIGHT", "OIL_CHANGE", "GENERAL_REPAIR", "FLUID_SERVICES"],
  packages: ["MAINTENANCE_LIGHT", "OIL_CHANGE", "GENERAL_REPAIR", "PREVENTIVE_PACKAGES"],

  // ── Diagnostic/Appointment types (ScheduleAppointmentScreen) ──
  diagnostic: ["DIAGNOSTICS"],
  steering: ["SUSPENSION", "GENERAL_REPAIR", "STEERING"],
  exhaust: ["ENGINE", "GENERAL_REPAIR", "EXHAUST"],
  cooling: ["ENGINE", "GENERAL_REPAIR", "COOLING_SYSTEM"],
  fuel_system: ["ENGINE", "GENERAL_REPAIR", "FUEL_SYSTEM"],
  ...
  drivetrain: ["TRANSMISSION", "GENERAL_REPAIR", "DRIVETRAIN"],
